...
/**
 * @param {import("../common/types").QueryResultDatabasePostInput|any} value
 * @returns {Either<import("../common/types").QueryResultDatabasePost, ValidatorErrorMap>}
 */
export function validateQueryResultDatabasePost(value) {
